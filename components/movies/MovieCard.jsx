...
const MovieCard = ({movie}) => {
    ...
    const {id,original_title,backdrop_path,release_date,first_air_date,original_name} = movie
  ...
  return (
    <Link href={`/movies/${id}`} className={styles.link}>
      <div className={styles.card}>
        <img src={`https://image.tmdb.org/t/p/w500${backdrop_path}`} className={styles.image}  />
